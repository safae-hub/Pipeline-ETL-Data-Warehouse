-- ============================================================
-- Mexora Analytics — Creation du Data Warehouse PostgreSQL
-- ============================================================
...
-- ============================================================
-- Dimension Client (SCD Type 1 avec champs compatibilite)
-- ============================================================
...
CREATE TABLE IF NOT EXISTS dwh_mexora.fait_ventes (
    ...
    -- Mesures non-additives (taux — a recalculer)
...
CREATE INDEX IF NOT EXISTS idx_dim_produit_nk  ON dwh_mexora.dim_produit(id_produit_nk);
CREATE INDEX IF NOT EXISTS idx_dim_client_nk   ON dwh_mexora.dim_client(id_client_nk);

-- ============================================================
-- Vue Materialisee 1 : CA mensuel par region et categorie
-- ============================================================
...
-- ============================================================
-- Vue Materialisee 2 : Top produits par trimestre
-- ============================================================
...
-- ============================================================
-- Vue Materialisee 3 : Performance livreurs (taux de retard)
-- ============================================================
...
-- ============================================================
-- Vue supplementaire : Taux de retour par categorie
-- ============================================================
CREATE MATERIALIZED VIEW IF NOT EXISTS reporting_mexora.mv_taux_retour AS
SELECT
    p.categorie,
